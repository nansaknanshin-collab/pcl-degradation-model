...
├── thickness analysis.py        # Film thickness variation study (Python)
├── Uncertainty analysis.m       # Bayesian inference via DE-MCz MCMC (MATLAB)
├── Sobol sensitivity analysis.m # Sobol global sensitivity analysis (MATLAB)
...
- No additional toolboxes required for `Uncertainty analysis.m` or `plottt.m`
...
```matlab
run('Uncertainty analysis.m')    % Bayesian inference + posterior figures
run('Sobol sensitivity analysis.m')  % Sobol sensitivity analysis
...
| `thickness analysis.py`         | `thickness_WL.png`, `thickness_Xc.png`, `comparison_WL.png`, `comparison_Xc.png`, `thickness_predictions.xlsx` |
| `Uncertainty analysis.m`        | `Figure 9.png`, `Figure 10.png`, `Figure 11.png`, `Shi_WL_PredictionUncertainty.png`, `Shi_Xc_PredictionUncertainty.png`, `Shi_PairwisePosterior.png` |
| `Sobol sensitivity analysis.m`  | `sobol_first_order_P.png`, `sobol_total_order_P.png`, `sobol_Si_P.csv`, `sobol_Ti_P.csv`, `sobol_indices_P.xlsx` |
